...
class Type10(BaseStruct):
    ...
    resource_storage: list[ResourceStorage] = Retriever(ResourceStorage, repeat=3,                                  default=ResourceStorage())
    ...
    telemetry_id: int            = Retriever(int16, Version(Dat.AOE1DE.ver()), Version(Dat.AOE1DE.ver()), default=0)
