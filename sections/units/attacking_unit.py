...
from binary_file_parser.types import int8, uint8, int16, float32, Array16, float16, Bytes
...
class AttackingUnit(BaseStruct):
    ...
    default_armor_5: int = Retriever(int16, Version(Dat.SWGB.ver()), Version(Dat.SWGB_EXPANSION.ver()),
                                     default=0)
